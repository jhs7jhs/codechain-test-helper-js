        ...
        switch (protocolId.readUIntBE(0, 1)) {
            case MessageType.NODE_ID_REQUEST: {
                ...
                return new SessionMessage(version.length === 0 ? 0 : version.readUIntBE(0, 1), seq.length === 0
                    ? new lib_1.U256(0)
                    : new lib_1.U256(parseInt(seq.toString("hex"), 16)), new NodeIdRequest(new NodeId(ip, port)));
            }
            case MessageType.NODE_ID_RESPONSE: {
                ...
                return new SessionMessage(version.length === 0 ? 0 : version.readUIntBE(0, 1), seq.length === 0
                    ? new lib_1.U256(0)
                    : new lib_1.U256(parseInt(seq.toString("hex"), 16)), new NodeIdResponse(new NodeId(ip, port)));
            }
            case MessageType.SECRET_REQUEST: {
                const secret = new H512_1.H512(bodyObject.toString("hex"));
                return new SessionMessage(version.length === 0 ? 0 : version.readUIntBE(0, 1), seq.length === 0
                    ? new lib_1.U256(0)
                    : new lib_1.U256(parseInt(seq.toString("hex"), 16)), new SecretRequest(secret));
            }
            case MessageType.SECRET_ALLOWED: {
                const secret = new H512_1.H512(bodyObject.toString("hex"));
                return new SessionMessage(version.length === 0 ? 0 : version.readUIntBE(0, 1), seq.length === 0
                    ? new lib_1.U256(0)
                    : new lib_1.U256(parseInt(seq.toString("hex"), 16)), new SecretAllowed(secret));
            }
            case MessageType.SECRET_DENIED: {
                return new SessionMessage(version.length === 0 ? 0 : version.readUIntBE(0, 1), seq.length === 0
                    ? new lib_1.U256(0)
                    : new lib_1.U256(parseInt(seq.toString("hex"), 16)), new SecretDenied(bodyObject.toString()));
            }
            case MessageType.NONCE_REQUEST: {
                return new SessionMessage(version.length === 0 ? 0 : version.readUIntBE(0, 1), seq.length === 0
                    ? new lib_1.U256(0)
                    : new lib_1.U256(parseInt(seq.toString("hex"), 16)), new NonceRequest(bodyObject));
            }
            case MessageType.NONCE_ALLOWED: {
                return new SessionMessage(version.length === 0 ? 0 : version.readUIntBE(0, 1), seq.length === 0
                    ? new lib_1.U256(0)
                    : new lib_1.U256(parseInt(seq.toString("hex"), 16)), new NonceAllowed(bodyObject));
            }
            case MessageType.NONCE_DENIED: {
                return new SessionMessage(version.length === 0 ? 0 : version.readUIntBE(0, 1), seq.length === 0
                    ? new lib_1.U256(0)
                    : new lib_1.U256(parseInt(seq.toString("hex"), 16)), new NonceDenied(bodyObject.toString()));
            }
            default:
